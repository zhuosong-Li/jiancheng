...
open_routes = ['/login',"/devproductionorder/download", '/orderimport/downloadorderdoc','/processsheet/download','/firstbom/download','/secondbom/download', '/firstpurchase/downloadpurchaseorderzip']
