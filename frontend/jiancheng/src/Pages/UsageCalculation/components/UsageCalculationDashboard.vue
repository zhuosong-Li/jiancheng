...
onMounted(() => {
    ...
    proxy.$axios
        .get(`${apiBaseUrl}/order/getprodordershoebystatus`, { params })
        .then((response) => {
    ...
    proxy.$axios
        .get(`${apiBaseUrl}/order/getprodordershoebystatus`, {
            params: { ordershoestatus: 11 } // Correctly wrap the parameters in `params`
        })
        .then((response) => {
