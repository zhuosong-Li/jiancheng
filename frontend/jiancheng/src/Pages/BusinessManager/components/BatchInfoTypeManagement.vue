...
export default {
    ...
    methods: {
        ...
        {
            await this.generalAPICall("删除", "/batchtype/deletebatchtype",{"batchTypeId":row.batchInfoTypeId})
            console.log(123)
        ...
        submitNewBatchInfoTypeForm()
        {
            ...
            {
                const response = await axios.post(`${this.$apiBaseUrl}/batchtype/addbatchtype`, this.batchInfoTypeForm)
