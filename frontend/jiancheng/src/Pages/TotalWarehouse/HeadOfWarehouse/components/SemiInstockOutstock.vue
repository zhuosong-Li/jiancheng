<template>
                ...
                <el-table-column label="操作" width="200">
                    <template #default="scope">
                        <el-button
                            ...
                            type="primary"
                            size="mini"
                            @click="semiInstockDialogVisible = true"
                            >入库</el-button
                        >
                        <el-button
                            v-else
                            type="success"
                            size="mini"
                            @click="semiOutstockDialogVisible = true"
                            >出库</el-button
                        >
                    </template>
                </el-table-column>
    ...
    <el-dialog title="半成品入库" v-model="semiInstockDialogVisible" width="30%">
        <el-row :gutter="20">
            <el-col :span="24" :offset="0">
    ...
    <el-dialog title="半成品出库" v-model="semiOutstockDialogVisible" width="30%">
        <el-row :gutter="20">
            <el-col :span="24" :offset="0">
                <el-form label-position="right" label-width="100px">
                    ...
                    <el-form-item label="出库方式">
                        <el-radio-group v-model="outstockForm.outstockType">
                            <el-radio label="1">内部出库</el-radio>
                            <el-radio label="2">外包出库</el-radio>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item label="出库工段">
                        <el-input
                            v-model="outstockForm.section"
                            placeholder="请输入出库工段"
                            :disabled="outstockForm.outstockType !== '1'"
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="领料人">
                        <el-input
                            v-model="outstockForm.receiver"
                            placeholder="请输入领料人"
                            :disabled="outstockForm.outstockType !== '1'"
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="外包信息"> </el-form-item>
                    <el-text>半成品最迟发货日期：{{ outstockForm.deadlineDate }}</el-text>
                    <el-form-item label="发货地址">
                        <el-input
                            v-model="outstockForm.address"
                            placeholder="请输入发货地址"
                            :disabled="outstockForm.outstockType !== '2'"
                        ></el-input>
                    </el-form-item>
                </el-form>
            </el-col>
...
export default {
    data() {
        return {
            ...
            semiOutstockDialogVisible: false,
            shoeFilterData: [
                {
