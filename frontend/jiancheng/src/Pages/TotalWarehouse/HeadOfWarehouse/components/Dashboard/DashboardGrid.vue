    ...
    methods: {
        ...
        openNewWindow(task) {
            ...
            switch(task.taskName) {
                case "一次采购入库":
                    url = `${window.location.origin}/headofwarehouse/firstWarehousing/orderid=${orderId}`;
                    break
                case "二次采购入库":
                    url = `${window.location.origin}/headofwarehouse/secondWarehousing/orderid=${orderId}`;
                    break
            }
